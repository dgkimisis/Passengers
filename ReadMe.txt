...
2.In Model Folder we areate a file named Passenger with a class Passenger with several atributes.
...
...Now just follow the process within the files themselves.....
